                ...
                <div className="card-film-item-desc">
                    ...
                    <div className="film-item-report">
                        ...
                        <div class="report-item">
                            ...
                            <div class="report-value">Pom Klementieff, Angela Bassett, Simon Pegg, Rob Delaney, Shea Whigham, Tom Cruise, Rebecca Ferguson, Vanessa Kirby, Ving Rhames, Hayley Atwell, Mark Gatiss, Henry Czerny, Cary Elwes, Charles Parnell, Greg Tarzan Davis, Sam Kalidi, Ross Donnelly, Esai Morales, Indira Varma, Frederick Schmidt, Christopher Sciueref, Yennis Cheung, Doroteya Toleva, Anton Saunders, Dani Dupont, Andrea Scarduzio, Nico Toffoli, Marcin Dorociński</div>
                        </div>
                    </div>
                </div>
             </div>
                            ...
                            <div className="program-item-imax">
                                ...
                                <div className="program-item-bow-link">
                                    <ul>
                                        ...
                                        <li><a className="program-item-link" href="/login">22:30</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
